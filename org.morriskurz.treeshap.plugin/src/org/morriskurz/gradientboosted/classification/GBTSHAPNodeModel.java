 ...
 */
public class GBTSHAPNodeModel extends NodeModel {
  /**
   ...
   */
  private static final NodeLogger LOGGER = NodeLogger.getLogger(GBTSHAPNodeModel.class);

  private TreeSHAPConfiguration configuration;

  /** Constructor for the node model. */
  protected GBTSHAPNodeModel() {
  ...
  private Optional<DataTableSpec> createOutputSpec(
    ...
    outSpec =
        TreeSHAPUtil.setupRearrangerCreatorGBT(dataSpec, modelSpec, null, configuration)
            .createSpec();
    return outSpec;
  }
    ...
    return new StreamableOperator() {
      ...
      public void runFinal(
        ...
        final ColumnRearranger rearranger =
            TreeSHAPUtil.setupRearrangerCreatorGBT(
                    dataSpec,
                    modelSpec,
