 ...
 */
public class TreeSHAPNodePlugin extends Plugin {
    // The shared instance.
    private static TreeSHAPNodePlugin plugin;

    /**
     * The constructor.
     */
    public TreeSHAPNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TreeSHAPNodePlugin getDefault() {
        return plugin;
    }
